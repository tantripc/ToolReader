...
window.addEventListener('load', function () {
    ...
    videojs.addLanguage('vi', {
        ...
        "Exit Picture-in-Picture": "Tắt cửa sổ thu nhỏ",
        "Picture-in-Picture": "Xem trong cửa sổ thu nhỏ"
    });
    ...
    if (getParamUrl('demo')) {
        ...
        if (validateYouTubeUrl(getParamUrl('url')) == true) {
            initPlayer({
                sources: [
                    {
                        src: getParamUrl('url'),
...
var player;
var pause_event_send = true;
function pause_player() {
    pause_event_send = false;
    player.pause();
}
...
function initPlayer(options) {
    ...
    if (parent.load_time_video) {
        parent.load_time_video(player, _id_content);
    }
    //player.disableProgress({
    //    autoDisable: options.disableProgress != undefined ? options.disableProgress : true
    //});
    ...
    player.on('play', function (e) {
        console.log('play');
        pause_event_send = true;
        //console.log(e);
        if (parent.event_play_video) {
            parent.event_play_video(player, _id_content);
        }
    });
    player.on('pause', function (e) {
        console.log('pause');
        //console.log(e);
        if (parent.event_pause_video && pause_event_send == true) {
            parent.event_pause_video(player, _id_content);
        }
    });
    ...
    player.on('seeked', function (e) {
        console.log('seeked');
        //console.log(e);
        if (parent.event_seeked_video) {
            parent.event_seeked_video(player, _id_content);
        }
    });
    player.on('ended', function (e) {
        console.log('ended');
        //console.log(e);
        if (parent.event_end_video) {
            parent.event_end_video(player, _id_content);
        }
    });
