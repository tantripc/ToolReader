...
class BookPreviewPublic {
    ...
    showAlert() {
      ...
      if (!this.isShow) {
        this.isShow = true;
        var alert = $(
          "<div style='display:none;z-index:99999;padding: 5px 20px;letter-spacing: 1px;left:50%;top:50%;transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);position:absolute;background:rgba(85,85,85,0.5);line-height:40px;font-size:18px;color:#fff;'>æ­¤è®¾ç½®æ— æ³•å®žæ—¶é¢„è§ˆï¼Œè¯·ç‚¹å‡»<span style='color:#ffa500'> \"åº”ç”¨è®¾ç½®\" </span>æŒ‰é’®</div>"
        );
        if (global.templeteName == "brief")
          alert.html(
            "æ­¤æ¨¡æ¿ä¸æ”¯æŒå®žæ—¶é¢„è§ˆï¼Œè¯·ç‚¹å‡»<span style='color:#ffa500'> \"åº”ç”¨è®¾ç½®\" </span>æŒ‰é’®"
          );
  ...
  class BookPreviewInterface extends BookPreviewPublic {
    ...
    showSoundButton() {
      ...
      if (
        (!bookConfig.FlipSound && !bookConfig.BackgroundSoundURL) ||
        this.isHasButton("sound")
      )
        return;
    ...
    playFlipSound(params) {
      // FlipSound BackgroundSoundButtonVisible
      if (global.templeteName == "brief") {
        this.showAlert();
        return;
      }
