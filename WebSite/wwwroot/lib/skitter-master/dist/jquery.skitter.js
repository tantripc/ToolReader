...
;(function (factory) {
  ...
  var defaults = {
    ...
    // Actual image_mini (internal)
    image_mini_atual: null,
  ...
  $sk.fn.extend({
    ...
    setup: function() 
    {
      ...
      var addImageLink = function (link, src, animation_type, label, target, src_mini) {
        self.settings.images_links.push([src, link, animation_type, label, target, src_mini]);
        ...
        $.ajax({
          ...
          success: function(xml) {
            ...
            $(xml).find('skitter slide').each(function(){
              ...
              addImageLink(link, src, animation_type, label, target, src_mini);
            });
          }
        });
      }
      ...
      // Load from HTML
        ...
        this.skitter_box.find('ul li').each(function(){
          ...
          var src_mini = $(this).find('img').attr('src_mini');
      ...
      this.settings.image_mini_atual = this.settings.images_links[0][5];
    ...
    loadImages: function () 
    {
      ...
      for (var i in this.settings.images_links) {
        ...
        var src = self.getImageName(self_il[0], self_il[5]);
        var img = new Image();
    ...
    setImageLink: function()
    {
      ...
      var name_image_mini = this.settings.images_links[this.settings.image_i][5];
      
      this.settings.image_atual = name_image;
      this.settings.link_atual = link_image;
      this.settings.label_atual = label_image;
      this.settings.target_atual = target_link;
      this.settings.image_mini_atual = name_image_mini;
    },
    ...
    getCurrentImage: function() {
      ...
      var image_mini = this.settings.image_mini_atual;
      return this.getImageName(image, image_mini);
    },
