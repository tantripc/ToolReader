...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.placeholderText = element.hasAttribute('placeholder') ? this.$element.attr('placeholder') : 'Nhập từ khóa';
    ...
    this.$container = $('<div class="bootstrap-tagsinput"></div>');
      this.$input = $('<input class="form-control" style="width:100%" type="' + this.type + '" name="' + this.name + '" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
