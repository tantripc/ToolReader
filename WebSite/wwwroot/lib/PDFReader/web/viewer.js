...
function posMess(str) {
    parent.parent.postMessage(str, "http://txbinh.lacviet.com.vn");
}
function webViewerInitialized() {
    ...
    if (!PDFView.supportsFullscreen) {
        ...
        if (document.getElementById('presentationMode_fullview')) {
            document.getElementById('presentationMode_fullview').addEventListener('click',
                function () {
                    //parent.parent.location.href = location.href.replace("smallviewer.html", "viewer.html") + "&url=" + encodeURI(parent.parent.location.href);
                    var url = "PdfReadersmall;" + location.href.replace("smallviewer.html", "viewer.html");
                    posMess(url);
        ...
        if (document.getElementById('presentationMode_fullview')) { document.getElementById('presentationMode_fullview').classList.add('hidden'); }
