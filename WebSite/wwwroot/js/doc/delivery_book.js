        ...
        success: function (data) {
            if (data != null) {
                InitDialogCourse({
                    ...
                    title: _localizer.phancongdocsachchonguoidunghoacnhomnguoidung, 
                    body: data,
                    footer: {
                        button: [
                            {
                            ...
                            },
                            {
                                ...
                                click: function () {
                                    ajax_addupdate_docinfo(id != undefined ? id : '', status)
                                },
                                isClose: false,
                            },
                        ]
...
function ajax_addupdate_docinfo(id, status) {
