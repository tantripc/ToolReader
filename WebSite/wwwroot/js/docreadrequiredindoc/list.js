...
loadKendoGrid({
    ...
    columns: [
        ...
        },
        {
            ...
            filterable: {
                messages: {
                    info: _localizer.loctennguoidung,
                    filter: _localizer.apdung,
                    clear: _localizer.xoa
                },
            },
        ...
        },
        {
            ...
            filterable: {
                messages: {
                    info: _localizer.loctheobatbuocdoc,
                    filter: _localizer.apdung,
                    clear: _localizer.xoa
                }, ui: filter
            },
            template: '#if(data.isrequired==false){#  #}# #if(data.isrequired ==true){# <i class=\"iconmoon iconmoon-right\" style=\"color:\\#1ED81D\"></i> #}# #if(data.isrequired==null){#  #}#',
...
function exportDocreadrequired(id) {
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data) {
                if (data.data != null && data.data.length > 0) {
                    ...
                    html += _localizer.phancongchonguoidung.replace('__numok__', (data.data[0].numok));
                    html += '</div>';
